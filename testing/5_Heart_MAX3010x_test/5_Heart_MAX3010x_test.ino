/* SensorChecker_RevA MAX30101 heart sensor check
...
#define MAX_SENSORS 1  // Leave this set at 1 for the SensorChecker
byte goodSensors = 127; // 127 == default, no good sensor found
